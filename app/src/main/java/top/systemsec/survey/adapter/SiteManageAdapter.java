...
public class SiteManageAdapter extends RecyclerView.Adapter<SiteManageAdapter.ViewHolder> {

    private List<SurveyBean> mSurveyBeans;

    public SiteManageAdapter(List<SurveyBean> surveyBeans) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mSaveTimeTextView.setText("提交时间： " + surveyBean.getSubmitTime());//时间
    }
