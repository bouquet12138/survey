...
import top.systemsec.survey.mobel.SiteManageModel;
import top.systemsec.survey.mobel.TempStorageModel;
import top.systemsec.survey.view.ISiteManageView;

public class SiteManagePresenter extends MVPBasePresenter<ISiteManageView> {

    private SiteManageModel mSiteManageModel = new SiteManageModel();//新建一个模型
    ...
    public void search() {
        ...
        List<SurveyBean> surveyBeans = mSiteManageModel.searchLocalSurveyBean(keyWord);//搜索一下
